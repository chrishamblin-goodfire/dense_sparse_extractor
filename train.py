...
try:
    # When running from repo root: `python -m dense_sparse_extractor.train`
    from dense_sparse_extractor.data import make_mnist_loaders
    from dense_sparse_extractor.models.convnet import ConvNetConfig, MNISTConvNet
    from dense_sparse_extractor.models.mlp import MLPConfig, MNISTMLP
    from dense_sparse_extractor.models.vit import ViTConfig, MNISTViT
except ImportError:  # pragma: no cover
    # When running from inside the package folder: `python train.py`
...
def main() -> None:
    ...
    default_model = here / "configs" / "model" / "baseline_mlp.yaml"
    default_train = here / "configs" / "training" / "baseline.yaml"
